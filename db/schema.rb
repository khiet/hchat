...
ActiveRecord::Schema.define(version: 20170406193818) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.index ["user_room_id"], name: "index_messages_on_user_room_id", using: :btree
  end
  ...
  add_foreign_key "messages", "user_rooms"
